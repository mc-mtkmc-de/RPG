...
public class WitherCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if(sender instanceof Player) {
			...
			if(player.hasPermission((String) config.get("Spawn.Wither"))) {
				SpawnUtil.spawnWither(player.getLocation());
				player.sendMessage("Du hast gerade einen Wither spawnen lassen");
			}
		}
