...
public class VillagerCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if(sender instanceof Player) {
			...
			if(player.hasPermission((String) config.get("Spawn.Villager"))) {
				SpawnUtil.spawnVillager(player.getLocation());
				player.sendMessage("Du hast gerade einen Händler spawnen lassen");
			}
		}
