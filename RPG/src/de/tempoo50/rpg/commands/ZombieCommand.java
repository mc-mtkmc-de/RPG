...
public class ZombieCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if(sender instanceof Player) {
			...
			if(player.hasPermission((String) config.get("Spawn.Zombie"))) {
				SpawnUtil.spawnZombie(player.getLocation());
				player.sendMessage("Du hast gerade ein Zombie spawnen lassen");
			}
		}
