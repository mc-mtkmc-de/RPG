...
public class BlazeCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if(sender instanceof Player) {
			...
			if(player.hasPermission((String) config.get("Spawn.Blaze"))) {
				SpawnUtil.spawnBlaze(player.getLocation());
				player.sendMessage("Du hast gerade einen Blaze spawnen lassen");
			}
		}
