...
public class SpiderCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if(sender instanceof Player) {
			...
			if(player.hasPermission((String) config.get("Spawn.Spider"))) {
				SpawnUtil.spawnSpider(player.getLocation());
				player.sendMessage("Du hast gerade eine Spinne spawnen lassen");
			}
		}
