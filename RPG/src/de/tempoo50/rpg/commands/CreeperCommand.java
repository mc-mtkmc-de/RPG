...
public class CreeperCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if(sender instanceof Player) {
			...
			if(player.hasPermission((String) config.get("Spawn.Creeper"))) {
				SpawnUtil.spawnCreeper(player.getLocation());
				player.sendMessage("Du hast gerade einen Creeper spawnen lassen");
			}
		}
